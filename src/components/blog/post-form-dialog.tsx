...
import { uploadImage } from "@/api/api.post";
                        ...
                        <Input
                            ...
                            {...register("imageUrl", {
                                validate: (value) => {
                                    ...
                                    const isImageService = /picsum\.photos|unsplash\.com|imgur\.com|cloudinary\.com/i.test(value);
                                    const hasImageExtension = /\.(jpg|jpeg|png|webp|gif|svg)(\?|$)/i.test(value);
